...
export default function RegisterPage() {
  ...
  const inputClass = "h-11 bg-slate-800/50 border-white/[0.08] text-white placeholder:text-slate-500 focus:border-blue-500/50 focus:ring-blue-500/20"
        ...
        <div className="bg-slate-900/80 border border-white/[0.07] rounded-2xl p-8 backdrop-blur-sm shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="password" type="password" placeholder="Min. 6 characters" required value={password}
            ...
            <div className="space-y-1.5">
              ...
              <Input id="confirm-password" type="password" placeholder="Repeat password" required value={confirmPassword}
            ...
            <div className="flex items-start gap-3 pt-1">
              ...
              <label htmlFor="terms" className="text-xs text-slate-400 leading-relaxed cursor-pointer">
                I accept the{" "}
                <Link href="/terms" className="text-blue-400 hover:text-blue-300 underline">Terms</Link>
                {" "}and{" "}
            ...
            <Button
              type="submit"
              className="w-full h-11 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-semibold shadow-lg shadow-blue-500/20 border-0 mt-2"
          ...
          <Button
            variant="outline"
            className="w-full h-11 border-white/[0.08] bg-white/5 text-slate-300 hover:bg-white/10 hover:text-white hover:border-white/15 transition-all"
            disabled={isLoading}
